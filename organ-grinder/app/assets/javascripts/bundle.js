...
/***/ function(module, exports, __webpack_require__) {
	...
	var KeyStore = __webpack_require__(10);
	...
	var Organ = React.createClass({
	  ...
	  render: function () {
	    var keyboard = Object.keys(TONES).map(function (tone, index) {
	      return React.createElement(Key, { key: index, noteName: tone });
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Key = React.createClass({
	  ...
	  render: function () {
	    var status = this.state.played === true ? "key played" : "key";
	    return React.createElement(
	      'span',
	      { className: status },
	      this.props.noteName
	...
	var Recorder = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement('input', { onChange: this.changeName, value: this.state.track.name, type: 'text', id: 'trackName' })
	    );
	  }
	});
